...
router.post('/', bodyHandler.checkBody(garagesCollection), garageController.createDocument);
...
router.put('/:id([a-zA-z0-9]{24})', bodyHandler.checkBody(garagesCollection), garageController.updateDocument);
